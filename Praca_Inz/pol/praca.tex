...
{Jednym z podstawowych problemów z dziedziny wizji komputerowej jest klasyfikacja. Polega ona na przypisaniu pewnej kategorii na podstawie obrazu. Zazwyczaj kategorie te to obiekty znajdujące się na zdjęciu. Chcemy więc, aby maszyna po zobaczeniu zdjęcia psa skategoryzowała go jako 'pies'. Do problemu klasyfikacji możemy dołożyć jeszcze inny problem - detekcji. Teraz chcemy, aby maszyna bo zobaczeniu zdjęcia psa nie tylko zidentyfkowała go jako psa, lecz również wskazała w którym miejscu na zdjeciu ten pies sie znajduje.}
\section{Konwolucyjne sieci neuronowe}
\subsection{Warstwy}%%poszczegolne warstwy?
